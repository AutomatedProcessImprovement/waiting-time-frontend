...
const UnavailabilitySpecificTransitionsLayout: React.FC<UnavailabilitySpecificTransitionsLayoutProps> = ({ jobId, selectedActivityPair }) => {
    const [sourceActivity, destinationActivity] = selectedActivityPair.split(' - ');
    const overviewData = useFetchData(`http://154.56.63.127:5000/wt_overview/${jobId}/unavailability/${sourceActivity}/${destinationActivity}`);
